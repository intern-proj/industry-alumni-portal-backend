...
import com.portal.user_service.dto.response.*;
...
public class UserProfileServiceImpl implements UserProfileService {
    ...
    private UserProfileResponseDto mapToDto(UserProfile profile) {
        ...
        List<ResumeResponseDto> resumeDtos = resumeRepository.findByUserIdOrderByUploadedAtDesc(profile.getUserId()).stream()
                .map(r -> ResumeResponseDto.builder()
                        ...
                        .storageFileId(r.getStorageFileId())
