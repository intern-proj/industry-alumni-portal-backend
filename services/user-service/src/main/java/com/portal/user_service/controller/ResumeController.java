...
import com.portal.user_service.service.ResumeService;
...
public class ResumeController {
    ...
    public ResponseEntity<ApiResponseDto<ResumeResponseDto>> updateResume(
        ...
        ResumeResponseDto updated = resumeService.updateResume(userId, resumeId, requestDto);
        return ResponseEntity.ok(ApiResponseDto.success(updated, "Resume updated successfully"));
    }
